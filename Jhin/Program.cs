    ...
    internal class Program
    {
        ...
        private static void OnGameLoad(EventArgs Args)
        {
            ...
            var PredMenu = Menu.AddSubMenu(new Menu("Prediction", "Prediction"));
            {
                ...
                { "Common Prediction", "OKTW Prediction", "SDK Prediction", "SPrediction(Need F5 Reload)", "xcsoft AIO Prediction" }, 1)));
            ...
            Game.PrintChat("Flowers' Jhin Load Succeed! Credit: NightMoon");
