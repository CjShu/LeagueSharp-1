namespace xSaliceResurrected.Mid
{
    ...
    public class Anivia : Champion
    {
        ...
        public Anivia()
        {
            ...
            SpellManager.Q.SetSkillshot(0.25f, 110f, 850f, false, SkillshotType.SkillshotLine);
        ...
        private void DetonateQ()
        {
            ...
            foreach (var enemy in ObjectManager.Get<Obj_AI_Hero>().Where(x => x.IsValidTarget(1200) && x.Distance(_qMissle.Position) < 200).OrderByDescending(GetComboDamage))
            {
        ...
        private void CheckR()
        {
            ...
            var hit = ObjectManager.Get<Obj_AI_Hero>().Count(x => _rObj.Position.Distance(x.ServerPosition) < 475 && x.IsValidTarget(R.Range + 500));
        ...
        private void Escape()
        {
            ...
            var enemy = (from champ in ObjectManager.Get<Obj_AI_Hero>() where champ.IsValidTarget(1500) select champ).ToList();
