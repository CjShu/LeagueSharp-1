...
namespace xSaliceResurrected.Mid
{
    class Karthus : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            {
                keys.AddItem(new MenuItem("Orbwalk", "Combo!", true).SetValue(new KeyBind(32, KeyBindType.Press)));
                keys.AddItem(new MenuItem("Farm", "Harass!", true).SetValue(new KeyBind("S".ToCharArray()[0], KeyBindType.Press)));
                keys.AddItem(new MenuItem("FarmT", "Harass (toggle)!", true).SetValue(new KeyBind("Y".ToCharArray()[0], KeyBindType.Toggle)));
