    ...
    class Program
    {
            ...
            try
            {
                if (E.IsReady())
                    if (Menu.Item("KillStealE", true).GetValue<bool>())
                        foreach (var e in ObjectManager.Get<Obj_AI_Hero>().Where(e => e.IsValidTarget(E.Range)))
        ...
        private static void ComboLogic()
        {
            try
            {
                ...
                //Game.PrintChat("IsKill  " + IsKill.ToString());
                if (e != null)
                {
                    ...
                    if (Menu.Item("ComboE", true).GetValue<bool>())
                    {
                        if (E.IsReady())
                        {
                            ...
                            {
                                //Game.PrintChat("Stack E Count -------" + GetEStackCount(e).ToString() + " ------- " + e.ChampionName);
