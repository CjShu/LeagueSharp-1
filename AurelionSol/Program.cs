namespace Flowers__AurelionSol
{
    ...
    class Program
    {
        ...
        private static void OnLoad(EventArgs args)
        {
            ...
            Game.PrintChat("<font color='#2848c9'>Flowers' AurelionSol</font> --> <font color='#b756c5'>Load! </font> <font size='30'><font color='#d949d4'>Good Luck!</font></font>");
        ...
        private static void ComboLogic()
        {
            ...
            if (Menu.GetBool("ComboQFollow"))
            {
                if (SecondQ && qqq != null)
                {
                    ...
                    Me.IssueOrder(GameObjectOrder.MoveTo, qqq.Position);
                }
