namespace Flowers__Annie
{
    ...
    class Program
    {
        ...
        private static void OnLoad(EventArgs args)
        {
            ...
            // Chat
            Game.PrintChat("<font color='#2848c9'>Flowers Annie</font> --> <font color='#b756c5'>Version : 1.0.0.3</font> <font size='30'><font color='#d949d4'>Good Luck!</font></font>");
        ...
        private static bool CanR(Obj_AI_Hero e)
        {
            if (HaveBear)
            {
                return false;
